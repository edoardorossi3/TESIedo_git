...
for i in range(0, Nz):
    f_name=work_dir+'sandage_varZ_v4.1_m'+z_list[i]+'fix_noburst_100k.fits'  #name of the file from that we get tform, tau, nbursts, ecc...
    ...
    h.writeto(work_dir+'t_f_m'+z_list[i]+'fix_noburst.fits', overwrite=True)
