...
for i in range (1, N_files+1):
    sndg_file=work_dir+'sandage_varZ_v4.2eq_spec_dcomb0p25null_{:03d}_physpar.fits'
    ...
    new_file=work_dir+'sandage_varZ_v4.2eq_spec_dcomb0p25null_{:03d}_physpar_wagef.fits'
